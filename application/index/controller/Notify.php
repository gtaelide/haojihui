...
class Notify extends NotifyHandler
{
    ...
    public function getOrder()
    {
        ...
        $subject = $_POST['title']."&&".$_POST['proid']."&&".$_POST['tel']."&&".$_POST['address']."&&".$_POST['name']."&&".$_POST['uid']."&&".$_POST['mid'];
        $body = $_POST['title']."&&".$_POST['proid']."&&".$_POST['tel']."&&".$_POST['address']."&&".$_POST['name']."&&".$_POST['uid']."&&".$_POST['mid'];
        $order = array(
    ...
    */
    ...
    public function zhihu(){
        $this->getOrder();
        $ass = \alipay\Wappay::pay($this->params);
    }
}